...
/* Private user code ---------------------------------------------------------*/
/* USER CODE BEGIN 0 */
const uint32_t tickcount_6s = pdMS_TO_TICKS(6000);
const uint32_t tickcount_4s = pdMS_TO_TICKS(4000);
const uint32_t tickcount_2s = pdMS_TO_TICKS(2000);
const uint32_t tickcount_50ms = pdMS_TO_TICKS(50);
